...
import { storeMessage as _storeMessage } from '~/lib/MessageStore';
...
export function addReceivedMessage(conversationId, message) {
  console.log('adding received messages', message);
...
export function storeMessage(message) {
  _storeMessage(message.id, message);
}

export function removeMessage(messageId) {
  _storeMessage(messageId, null);
}
