...
function addReceivedMessage(conversationId, message) {
...
function updateProfileOrSeen(data) {
...
class CCable {
  ...
  sendMessage = (meProfileId, conversationId, message) => {
    return this._sendMessage(meProfileId, conversationId, message).catch(
      (e) => {
